...
function ae_user_package_info($user_ID) {
    ...
    ?>
            ...
            <?php
                ...
                if ($order->post_status == 'pending') printf(__("You purchased package <strong>%s</strong> and have %d post(s). The project you've posted is pending until admin approves your payment.", ET_DOMAIN) , $package->post_title, $number_of_post);
    ?>
            </p>
