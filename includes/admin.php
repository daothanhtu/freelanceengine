...
?>
    ...
    function get_default_options() {
        ...
        return apply_filters('fre_default_setting_option', array(
            ...
            'register_social_mail_template' => '<p>Hello [display_name],</p><p>You have successfully registered an account with &nbsp;&nbsp;[blogname].&nbsp;Here is your account information:</p><ol><li>Username: [user_login]</li><li>Email: [user_email]</li><li>Password: [user_pass]</li></ol><p>Thank you and welcome to [blogname].</p>',
